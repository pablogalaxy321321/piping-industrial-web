...
export default function App() {
  ...
  const { images, loadedCount } = useImageSequence({
    basePath,
    count: framesCount || 1,
    preload: 60,
  });
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      // Ajuste de tamaño del canvas con DPR cap y sólo si cambió el viewport
    ...
    const st = ScrollTrigger.create({
      ...
      onUpdate: (self) => {
        ...
        currentIndex = target;
        // Glow overlay sincronizado con el progreso
  ...
  return (
    <div className="bg-black text-gray-200">
      ...
      <main>
        ...
        <section id="hero-video-section" className="relative h-[300vh]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="service-card p-8 rounded-xl">
                ...
                <p className="text-gray-400">
                  ...
                  modelos 3D precisos que optimizan el rendimiento y evitan
                  interferencias.
                </p>
              </div>
              <div className="service-card p-8 rounded-xl">
                ...
                <p className="text-gray-400">
                  Contamos con talleres equipados para la fabricación de spools
                  y flanges, asegurando un montaje preciso y eficiente en faena.
                </p>
              </div>
              <div className="service-card p-8 rounded-xl">
                <h3 className="text-2xl font-bold text-white mb-2">
